...
if (dinnerInvite.length > max_person) {
    console.log("Unfortunately we have only 2 person's seat on the table sorry i'll arrange it again on another day\n");
...
for (let i = 0; i < dinnerInvite.length; i++) {
    console.log(`Dear ${dinnerInvite[i]}! Today i'm organising a dinner party and you are still invited.\n`);
}
dinnerInvite.pop();
dinnerInvite.pop();
