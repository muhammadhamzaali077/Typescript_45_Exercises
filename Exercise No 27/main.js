...
if (userAsk.alien_color === "Green") {
    ...
    console.log("Congratulations! You earned 10 points for shooting down the green alien.");
}
else if (userAsk.alien_color === "Red") {
    console.log("Congratulations! You earned 15 points for shooting down the green alien.");
}
